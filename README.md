...
- Deploy applications with Helm in the offline environment
...
4. **Application Deployment**: Deploy applications using Helm with the locally available artifacts
...
capsailer deploy --chart nginx --values nginx-values.yaml
```
